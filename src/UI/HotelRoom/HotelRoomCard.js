    ...
    render() {
        ...
        return (
            ...
            <div className="hotel_room_img">
                ...
                <span className="hotel_show_amenities" onClick={e => this.getAmenities(e, room.amenities_url)}><FaListAlt />  show amenities</span>
                {
                ...
                <p className="room_type_count"><FaDoorOpen /> room type count: {room.room_count} </p>
                <p className="hotel_guest_count"><FaUserFriends /> max guest count: {room.max_capacity}</p>
                </div>
                <div className="hotelroom_price">
                <h3 className="hotel_room_after_dis">Rs.{room.price_after_discount}</h3>
