        ...
        return (
            ...
            <div className="card-container">
                    <div className='footer-area'>
                        ...
                        <img src={require("../../assets/images/khozinfo.png")} alt="Khozinfo Logo" id="logo" /> 
                        ...
                        <div className='footer-contacts'>
                            ...
                            <img src={require("../../assets/images/place.svg")} alt="place svg" /> <br />
                            <label>Kalikanagar, Butwal-11</label> <br />
                            <img src={require("../../assets/images/call.svg")} alt="call svg" /> <br />
                            <label>071-547678</label>
                            <label> <pre>  +977 9857011016</pre></label>
                            <img src={require("../../assets/images/mail.svg")} alt="mail svg" /> <br />
